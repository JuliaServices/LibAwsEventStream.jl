...
function Base.getproperty(x::Ptr{aws_event_stream_header_value_pair}, f::Symbol)
    ...
    f === :header_value && return Ptr{__JL_Ctag_101}(x + 260)
    f === :header_value_len && return Ptr{UInt16}(x + 276)
    f === :value_owned && return Ptr{Int8}(x + 278)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{aws_event_stream_streaming_decoder}, f::Symbol)
    ...
    f === :working_buffer && return Ptr{NTuple{12, UInt8}}(x + 4)
    f === :message_pos && return Ptr{Csize_t}(x + 16)
    f === :running_crc && return Ptr{UInt32}(x + 20)
    f === :current_header_name_offset && return Ptr{Csize_t}(x + 24)
    f === :current_header_value_offset && return Ptr{Csize_t}(x + 28)
    f === :current_header && return Ptr{aws_event_stream_header_value_pair}(x + 32)
    f === :prelude && return Ptr{aws_event_stream_message_prelude}(x + 312)
    f === :state && return Ptr{Ptr{aws_event_stream_process_state_fn}}(x + 324)
    f === :on_payload && return Ptr{Ptr{aws_event_stream_process_on_payload_segment_fn}}(x + 328)
    f === :on_prelude && return Ptr{Ptr{aws_event_stream_prelude_received_fn}}(x + 332)
    f === :on_header && return Ptr{Ptr{aws_event_stream_header_received_fn}}(x + 336)
    f === :on_complete && return Ptr{Ptr{aws_event_stream_on_complete_fn}}(x + 340)
    f === :on_error && return Ptr{Ptr{aws_event_stream_on_error_fn}}(x + 344)
    f === :user_context && return Ptr{Ptr{Cvoid}}(x + 348)
    return getfield(x, f)
end
