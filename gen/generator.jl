...
const refs_to_remove = ("INT16_MAX",)
...
const deps_jlls = [aws_c_cal_jll, aws_c_common_jll, aws_c_io_jll, aws_checksums_jll]
const deps = [LibAwsCal, LibAwsChecksums, LibAwsCommon, LibAwsIO]
...
for target in JLLEnvs.JLL_ENV_TRIPLES
    ...
    header_dirs = []
    inc = JLLEnvs.get_pkg_include_dir(aws_c_event_stream_jll, target)
    push!(args, "-I$inc")
